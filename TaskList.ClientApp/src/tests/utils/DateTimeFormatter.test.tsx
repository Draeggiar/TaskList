...
describe('DateTimeFormatter', () => {
  describe('isoToFormatedDateTime', () => {
    ;[
      { value: '2003-02-01T04:05', expected: '01-02-2003 04:05' },
      { value: '2003-02-01T14:05:06', expected: '01-02-2003 14:05' },
      { value: '2020-02-29T00:00', expected: '29-02-2020 00:00' },
      { value: '2003-02-01T04:05:00+01:00', expected: '01-02-2003 04:05' },
    ].forEach(testCase => {
  ...
  describe('formatedDateTimeToIso', () => {
    ;[
      { value: '01-02-2003 4:05', expected: '2003-02-01T04:05:00+01:00' },
